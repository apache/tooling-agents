...
async def run(input_dict, tools):
    ...
    try:
        ...
        # =============================================================
        # Step 1: Read files from data store (with optional pre-scoping)
        # =============================================================
        ...
        for ns in namespaces:
            ...
            # --- NEW: Pre-scope to includeFiles if provided ---
            if include_files:
        ...
        # =============================================================
        # Step 2: Relevance filtering (SKIPPED when includeFiles provided)
        # =============================================================
        if include_files:
...
"""
        ...
        # --- BUILD SYSTEM PROMPT WITH NEW INPUTS ---
...
"""
        ...
        # Inject severity threshold if provided
        if severity_threshold:
...
"""
        ...
        # Inject false positive guidance if provided
